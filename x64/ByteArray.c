...
int ByteArrayRef_Normalize(BAref str,int offset)
{
	if (offset < 0)
	{
...
int ByteArrayRef_Bound(BAref str,int offset,int len)
{
...
BAref ByteArrayRef__OverwriteIn(BAref dst,BAref src,int offd,int offs,int len)
{
